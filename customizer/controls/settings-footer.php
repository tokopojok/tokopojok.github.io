...
$wp_customize->add_setting('complete[foot_cols1_content]', array(
	'type' => 'option',
	'default' => '<div class="contact-details">
...
//----------------------Footer Columns 2----------------------------------
	$wp_customize->add_setting('complete[foot_cols2_title]', array(
		'type' => 'option',
		'default'	=> __('Working Hours','complete'),
		'sanitize_callback' => 'wp_kses_post',
		'transport' => 'postMessage',
	) );
...
$wp_customize->add_setting('complete[foot_cols2_content]', array(
	'type' => 'option',
	'default' => '[working-hours day="Monday - Friday" time="10.00am - 8.00pm" daycolor="#ffffff" timecolor="#78cc25" bordercolor="#292d3a"]
...
$wp_customize->add_setting('complete[foot_cols3_content]', array(
	'type' => 'option',
	'default' => '<img style="margin-top: 8px; width: 100%;" src="'.get_template_directory_uri().'/images/insta-img.png">',
	'sanitize_callback' => 'wp_kses_post',
	'transport' => 'postMessage',
) );
