<?php
/**
 * The Core Functions for SKT Ele Pet Lite
 *
...
// Working Hours
/*[working-hours day="Monday - Friday" time="10.00am - 8.00pm" daycolor="#ffffff" timecolor="#78cc25" bordercolor="#292d3a"]*/
function working_hours_func($atts){
		extract( shortcode_atts(array(
		'day' => 'day',
		'time' => 'time',
		'daycolor' => '#ffffff',
		...
		return '
			<div class="skt-working-hours" style="border-color:'.$bordercolor.';">
				<span style="color:'.$daycolor.';" class="skt-working-day">'.$day.'</span>
				<span style="color:'.$timecolor.';" class="skt-working-time">'.$time.'</span>
			</div>
		';
}
